...
const Sidebar = ({ open, setOpen }: SidebarProps) => {
  ...
  return (
    <div className="relative flex h-full">
      {/* Collapsed sidebar */}
      {collapsed && (
        <div className="fixed inset-y-0 left-0 z-50 w-12 bg-background border-r flex flex-col items-center py-4">
          <div className="h-8 w-8 bg-iatros-blue rounded-md flex items-center justify-center mb-6">
          ...
          <div className="flex-1 flex flex-col items-center gap-4">
            ...
            <Button 
              variant="ghost" 
              size="icon" 
              className={cn(activeSection === "chats" && "bg-muted")}
              title="Chats"
            >
            ...
            <Button 
              variant="ghost" 
              size="icon" 
              className={cn(activeSection === "patients" && "bg-muted")}
              title="Pacientes"
            >
          ...
          <div className="mt-auto mb-4">
            <div className="w-8 h-8 rounded-full bg-iatros-blue flex items-center justify-center text-white text-sm">
              RF
            </div>
          </div>
        </div>
      ...
      <button 
        ...
        className="absolute -right-3 top-1/2 z-[60] flex h-6 w-6 -translate-y-1/2 items-center justify-center rounded-full border bg-background shadow-md"
      >
      ...
      >
        <CollapsibleContent className="flex flex-col h-full">
